# Les2.2 Oefening 2.2B: Straming Setup Manager

## Beschrijving
Ik heb een script gemaakt dat mijn streaming setup bijhoudt zoals een echte streamer dashboard.

## Wat ik heb geleerd
- Ik heb geleerd hoe variabelen en datatypes gebruiken door een streaming setup te beheren.
## Demo
![video](Les22.2.gif)
## Code
```code
