# Les3.2 Oefening 3.2A: Muziek Speler Functie

## Beschrijving
Ik heb een script gemaakt dat verscillende muziekfuncties bevat, zoals play, stop en volume aanpassen.

## Wat ik heb geleerd
- Ik heb geoefend met functies, argumenten en return types door een simpele muziekspeler te maken.
## Demo
![foto](Les3.2.png)
## Code
```code
